...
#define SIZE_X				 800				// 設定遊戲畫面的解析度為800*600
...
#define DEFAULT_BG_COLOR	 RGB(255,255,255)   //RGB(0,0,0)	//// 遊戲畫面預設的背景顏色//(白色)255,255,255 //(黑色) 0,0,0
...
class CInteger
{
    ...
    private:
        ...
        static CMovingBitmap digit[21]; // 儲存0..9及負號之圖形(bitmap)
