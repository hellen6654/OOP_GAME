...
void CInteger::LoadBitmap()
{
    ...
    if (!isBmpLoaded)
    {
        digit[0].LoadBitmap(".\\RES\\number\\0.bmp", RGB(255, 255, 255));
        digit[1].LoadBitmap(".\\RES\\number\\1.bmp", RGB(255, 255, 255));
        digit[2].LoadBitmap(".\\RES\\number\\2.bmp", RGB(255, 255, 255));
        digit[3].LoadBitmap(".\\RES\\number\\3.bmp", RGB(255, 255, 255));
        digit[4].LoadBitmap(".\\RES\\number\\4.bmp", RGB(255, 255, 255));
        digit[5].LoadBitmap(".\\RES\\number\\5.bmp", RGB(255, 255, 255));
        digit[6].LoadBitmap(".\\RES\\number\\6.bmp", RGB(255, 255, 255));
