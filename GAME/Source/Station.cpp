...
void Station::LoadBitmap()
{
    if (stationType == 0)
    {
        ...
        stationAnimationNight.LoadBitmap(".\\RES\\Station\\Station_Circle_night.bmp", RGB(255, 255, 255));
    }
    else if (stationType == 1)
    {
        stationAnimation.LoadBitmap(".\\RES\\Station\\Station_Triangle.bmp", RGB(255, 255, 255));
        stationAnimationNight.LoadBitmap(".\\RES\\Station\\Station_Triangle_night.bmp", RGB(255, 255, 255));
    }
    else if (stationType == 2)
    {
        stationAnimation.LoadBitmap(".\\RES\\Station\\Station_Square.bmp", RGB(255, 255, 255));
        stationAnimationNight.LoadBitmap(".\\RES\\Station\\Station_Square_night.bmp", RGB(255, 255, 255));
    }
    else if (stationType == 3)
    {
        stationAnimation.LoadBitmap(".\\RES\\Station\\Station_Diamond.bmp", RGB(255, 255, 255));
        stationAnimationNight.LoadBitmap(".\\RES\\Station\\Station_Diamond_night.bmp", RGB(255, 255, 255));
    }
    else if (stationType == 4)
    {
        stationAnimation.LoadBitmap(".\\RES\\Station\\Station_Pentagon.bmp", RGB(255, 255, 255));
        stationAnimationNight.LoadBitmap(".\\RES\\Station\\Station_Pentagon_night.bmp", RGB(255, 255, 255));
    }
    else if (stationType == 5)
    {
        stationAnimation.LoadBitmap(".\\RES\\Station\\Station_Hexagon.bmp", RGB(255, 255, 255));
        stationAnimationNight.LoadBitmap(".\\RES\\Station\\Station_Hexagon_night.bmp", RGB(255, 255, 255));
    }
}
...
void Station::SetIsNight(bool z)
{
    isNight = z;
}
...
void Station::OnShowStation()
{
    ...
    stationAnimationNight.SetTopLeft(x, y);

    if (isNight)
    {
        stationAnimationNight.ShowBitmap();
    }
    else
    {
