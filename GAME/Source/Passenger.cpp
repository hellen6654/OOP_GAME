...
void Passenger::LoadBitmap()
{
    if (passengerType == 0)
    {
        ...
        passengerAnimationNight.LoadBitmap(".\\RES\\passenger\\Passenger_Circle_night.bmp", RGB(255, 255, 255));
    }
    else if (passengerType == 1)
    {
        passengerAnimation.LoadBitmap(".\\RES\\passenger\\Passenger_Triangle.bmp", RGB(255, 255, 255));
        passengerAnimationNight.LoadBitmap(".\\RES\\passenger\\Passenger_Triangle_night.bmp", RGB(255, 255, 255));
    }
    else if (passengerType == 2)
    {
        passengerAnimation.LoadBitmap(".\\RES\\passenger\\Passenger_Square.bmp", RGB(255, 255, 255));
        passengerAnimationNight.LoadBitmap(".\\RES\\passenger\\Passenger_Square_night.bmp", RGB(255, 255, 255));
    }
    else if (passengerType == 3)
    {
        passengerAnimation.LoadBitmap(".\\RES\\passenger\\Passenger_Diamond.bmp", RGB(255, 255, 255));
        passengerAnimationNight.LoadBitmap(".\\RES\\passenger\\Passenger_Diamond_night.bmp", RGB(255, 255, 255));
    }
    else if (passengerType == 4)
    {
        passengerAnimation.LoadBitmap(".\\RES\\passenger\\Passenger_Pentagon.bmp", RGB(255, 255, 255));
        passengerAnimationNight.LoadBitmap(".\\RES\\passenger\\Passenger_Pentagon_night.bmp", RGB(255, 255, 255));
    }
    else if (passengerType == 5)
    {
        passengerAnimation.LoadBitmap(".\\RES\\passenger\\Passenger_Hexagon.bmp", RGB(255, 255, 255));
        passengerAnimationNight.LoadBitmap(".\\RES\\passenger\\Passenger_Hexagon_night.bmp", RGB(255, 255, 255));
    }
}
...
void Passenger::SetIsNight(bool z)
{
    isNight = z;
}
...
void Passenger::OnShow()
{
    ...
    passengerAnimationNight.SetTopLeft(x, y);

    if (isNight)
    {
        passengerAnimationNight.ShowBitmap();
    }
    else
    {
